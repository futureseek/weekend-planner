...
const HEADER_TEXT = {
  zh: {
    title: "Roam 漫游",
    badge: "本地路线规划",
    subtitle: "区域 POI 检索 · 多日拆分 · 活动线索 · 个性化预算",
    features: ["多方案", "预算匹配", "活动参考", "地图联动"],
    showCanvas: "查看路线板",
    switchLabel: "EN",
  },
  en: {
    ...
    subtitle: "Area POI search · Multi-day split · Event signals · Personalized budget",
    features: ["Options", "Budget fit", "Events", "Map linked"],
